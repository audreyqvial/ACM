...
Généré : 2026-08-07 10:38:07 UTC
...
- Cas exécutés : 9
- Oracles vérifiés par digest : INCOMPLET
...
| --- | --- | --- | --- | --- |
| crewai | local | 3 | 2.12 | oui |
| crewai | intermediate | 3 | 2.09 | oui |
| crewai | global | 3 | 2.12 | oui |
| langgraph | local | 3 | 2.20 | oui |
| langgraph | intermediate | 3 | 2.10 | oui |
| langgraph | global | 3 | 2.09 | oui |
| openai-agents | local | 3 | 2.11 | oui |
| openai-agents | intermediate | 3 | 2.10 | oui |
| openai-agents | global | 3 | 2.11 | oui |
